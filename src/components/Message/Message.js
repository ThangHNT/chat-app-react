...
function Message({ reciever = false, text = false, children, onClick, img = false, ...passprops }) {
    ...
    return (
        <div className={cx('wrapper', { reciever })} onMouseOver={handleDisplayAction} onMouseOut={handleHideAction}>
